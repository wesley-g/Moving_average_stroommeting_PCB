...
const Timer_A_UpModeConfig upModeConfig =
{
        ...
        TIMER_A_CLOCKSOURCE_DIVIDER_1,       // ACLK/1 = 32Khz //32768 Hz
        252,                                 // 16384
...
int main(void)
{
    ...
    /* Setting up the GPIO */
    MAP_GPIO_setAsOutputPin(GPIO_PORT_P8, GPIO_PIN6);   //MCU LED
    ...
    MAP_GPIO_setOutputHighOnPin(GPIO_PORT_P8, GPIO_PIN6);   //MCU LED High
